...
// ─── StatsBar V1 ─────────────────────────────────────────────────────────────
w(B1 + '/src/components/landing/StatsBar.tsx', [
  ...
  '                <div className="font-oswald font-bold text-3xl md:text-4xl text-brand"',
  '                  style={{ opacity: isVisible ? 1 : 0, transition: `opacity 0.5s ease ${idx * 100}ms` }}>',
  '                  <AnimatedCounter value={stat.value} suffix={stat.suffix} prefix={stat.prefix} duration={1800} isVisible={isVisible} />',
  '                </div>',
  '                <p className="font-inter text-xs text-cream-muted tracking-wider uppercase">{stat.label}</p>',
...
// ─── BookingSection V1 ────────────────────────────────────────────────────────
w(B1 + '/src/components/landing/BookingSection.tsx', [
  ...
  '              className="flex items-center gap-4 p-5 rounded-xl border border-dark-border hover:border-brand bg-dark-card hover:bg-dark-surface transition-all duration-200">',
  ...
  '              <span className="font-inter text-sm text-cream-muted">Seg \u2013 Qui: <span className="text-cream font-medium">09h \u2013 19h</span></span>',
...
// ─── ServicesSection V1 ───────────────────────────────────────────────────────
w(B1 + '/src/components/landing/ServicesSection.tsx', [
...
// ─── SpaceSection V1 ─────────────────────────────────────────────────────────
w(B1 + '/src/components/landing/SpaceSection.tsx', [
  ...
  '                  <svg viewBox="0 0 24 24" className="w-8 h-8 text-brand" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',
  '                </div>',
  ...
  '                    i === active ? "bg-brand text-dark border-brand" : "border-dark-border text-cream-muted hover:border-brand hover:text-brand"',
  '                  }`}>{r.label}</button>',
  '              ))}',
  '            </div>',
  '            <div>',
...
// ─── GallerySection V1 ───────────────────────────────────────────────────────
w(B1 + '/src/components/landing/GallerySection.tsx', [
  'import { useState } from "react"',
  ...
  '                c.key === cat ? "bg-brand text-dark border-brand" : "border-dark-border text-cream-muted hover:border-brand hover:text-brand"',
  '              }`}>{c.label}</button>',
  '          ))}',
  '        </div>',
...
// ─── TestimonialsSection V1 ───────────────────────────────────────────────────
w(B1 + '/src/components/landing/TestimonialsSection.tsx', [
  ...
  '            <button onClick={prev} className="w-10 h-10 rounded-full border border-dark-border flex items-center justify-center text-cream-muted hover:border-brand hover:text-brand transition-all"><ChevronLeft size={18}/></button>',
  ...
  '              ))}',
  '            </div>',
  '            <button onClick={next} className="w-10 h-10 rounded-full border border-dark-border flex items-center justify-center text-cream-muted hover:border-brand hover:text-brand transition-all"><ChevronRight size={18}/></button>',
  '          </div>',
  '        </div>',
  '      </div>',
  '    </section>',
...
// ─── LocationSection V1 ──────────────────────────────────────────────────────
w(B1 + '/src/components/landing/LocationSection.tsx', [
  ...
  '                <div className="w-10 h-10 rounded-full bg-brand/10 border border-brand/20 flex items-center justify-center shrink-0"><MapPin size={18} className="text-brand"/></div>',
  '                <div>',
  ...
  '                  <a href={BUSINESS.googleMapsLink} target="_blank" rel="noopener noreferrer" className="font-inter text-xs text-brand hover:underline mt-1 inline-block">Ver no Google Maps \u2192</a>',
  '                </div>',
  '              </div>',
  '              <div className="flex items-start gap-4">',
  '                <div className="w-10 h-10 rounded-full bg-brand/10 border border-brand/20 flex items-center justify-center shrink-0"><Clock size={18} className="text-brand"/></div>',
  '                <div className="flex-1">',
  ...
  '              <a href={`https://wa.me/${BUSINESS.whatsapp}`} target="_blank" rel="noopener noreferrer">',
  '                <Button size="lg" className="w-full bg-green-700 hover:bg-green-600 border-0 text-white"><MessageCircle size={18} className="mr-2"/> WHATSAPP</Button>',
  '              </a>',
  '              <div className="grid grid-cols-2 gap-3">',
  '                <a href={`tel:${BUSINESS.phone}`}><Button variant="outline" size="sm" className="w-full"><Phone size={14} className="mr-2"/> Ligar</Button></a>',
  '                <a href={BUSINESS.instagramUrl} target="_blank" rel="noopener noreferrer"><Button variant="outline" size="sm" className="w-full"><Instagram size={14} className="mr-2"/> Instagram</Button></a>',
  '              </div>',
  '            </div>',
  '          </div>',
  '        </div>',
...
// ─── VideoSection V1 ─────────────────────────────────────────────────────────
w(B1 + '/src/components/landing/VideoSection.tsx', [
  ...
  '          <h2 className="font-oswald font-bold text-4xl md:text-5xl text-cream mb-4 tracking-wider">O Espa\u00e7o em V\u00eddeo</h2>',
  '          <GoldDivider className="max-w-xs mx-auto"/>',
  '        </div>',
  '        <div ref={ref} className="relative rounded-2xl overflow-hidden border border-dark-border transition-all duration-700"',
  '          style={{ opacity: isVisible ? 1 : 0, transform: isVisible ? "none" : "scale(0.97)" }}>',
  '          <div className="aspect-video bg-dark-surface">',
  ...
  '            </video>',
  '            <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 video-placeholder">',
  '              <div className="w-20 h-20 rounded-full border-2 border-brand/40 flex items-center justify-center bg-brand/10">',
  '                <Play size={32} className="text-brand ml-1"/>',
  '              </div>',
  '              <div className="text-center">',
  '                <p className="font-oswald text-cream font-bold text-sm tracking-widest mb-1">AMBIENTE BARBEZA</p>',
...
console.log('\nTodos os arquivos do V1 gravados em UTF-8 correto!')
