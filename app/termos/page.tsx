  ...
  return (
    <main className="min-h-screen bg-black text-slate-300">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <Link href="/" className="text-neon text-sm hover:underline">← Voltar ao início</Link>
        <h1 className="text-3xl font-black text-white mt-6 mb-2">Termos de Uso</h1>
        <p className="text-slate-500 text-sm mb-10">Brasília Consultoria em Licitações</p>

        <div className="space-y-6 text-sm leading-relaxed">
          <section>
            <h2 className="text-white font-bold text-lg mb-2">1. Aceitação</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">2. O serviço</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">3. Natureza informativa</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">4. Conta e uso</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">5. Planos e pagamentos</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">6. Contato</h2>
            <p>
              Dúvidas sobre estes termos? Fale conosco pelo{' '}
              <a href="https://wa.me/5531987551055" target="_blank" rel="noopener noreferrer" className="text-neon hover:underline">WhatsApp</a>.
            </p>
          </section>
        </div>
      </div>
