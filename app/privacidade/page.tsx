  ...
  return (
    <main className="min-h-screen bg-black text-slate-300">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl font-black text-white mt-6 mb-2">Política de Privacidade</h1>
        <p className="text-slate-500 text-sm mb-10">Brasília Consultoria em Licitações</p>

        <div className="space-y-6 text-sm leading-relaxed">
          <section>
            <h2 className="text-white font-bold text-lg mb-2">1. Dados que coletamos</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">2. Como usamos seus dados</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-bold text-lg mb-2">3. Dados públicos de licitações</h2>
            <p>
